...
namespace nc
{
    ...
    InputSystem::eButtonState InputSystem::GetButtonState(int id)
    {
        ...
        if (buttonDown)
        {
            state = (prevButtonDown) ? InputSystem::eButtonState::HELD : InputSystem::eButtonState::PRESSED;
        }
        else
        {
            state = (prevButtonDown) ? InputSystem::eButtonState::RELEASED : InputSystem::eButtonState::IDLE;
        }
